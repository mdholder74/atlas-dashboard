...
const routes: Routes = [
  { path: '', redirectTo: '/courses', pathMatch: 'full' }, // Redirect empty path to courses
  { path: 'courses', component: CouresList, title: 'Course List' },
  { path: 'courses/:id', component: CourseDetail },
  {
    path: 'commit-forms/:id',
    component: CommitmentForm,
    title: 'Commit to Course',
  }, // This route is for committing to a course, it uses the same component as course detail
];
